(function () {
  ...
  var SECTIONS = [
    ...
    { id: "cases", title: "Case studies", keywords: "rozgar migration mongodb mysql swiftcab zamtel kafka matching llm rag" },
    ...
    { id: "systems", title: "Systems depth", keywords: "kafka redis api gateway jwt oauth kubernetes aws fintech distributed rag llm n8n" },
    { id: "facts", title: "At a glance", keywords: "open to roles domain stack location timezone" },
    { id: "certificates", title: "Certificates", keywords: "oracle kubernetes aws elasticsearch hackerrank internshala" },
    { id: "skills", title: "Skills", keywords: "java spring nestjs kafka redis react next aws docker kubernetes typescript python rag llm" },
    { id: "resume", title: "Resume & Experience", keywords: "paytm policybazaar value innovation labs education btech september pdf" },
    ...
    { id: "proof", title: "Proof & social", keywords: "resume github linkedin youtube recommendations ccil rozgar codexcave september pdf" },
